      ...
      <Content hasHeader contentContainerStyle={styles.container}>
        ...
        <View>
          <SelectDropdown
            data={qualification ?? []}
            label="Education"
            value={String(data?.education_type)}
            placeholder="Select Education Type"
            dropDownStyle={styles.inputStyle}
            onSelectChange={item =>
              handleTextChange('education_type', String(item.id))
            }
          />
          ...
          {data?.education_type === '1' ? (
            <SelectDropdown
              ...
              dropDownStyle={styles.inputStyle}
              onSelectChange={item =>
                handleTextChange('institution', String(item.id))
              }
            />
          ) : (
            <>
